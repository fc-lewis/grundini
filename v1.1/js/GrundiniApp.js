define([
  'js/mvc/models/GrundiniAppModel',
  'js/mvc/controllers/BrowseIllustrationsController',
  'js/mvc/partialViews/NavigationMenuView',
  'js/mvc/controllers/ContentController',
  'js/mvc/views/ContentView'
], function(GrundiniModel, BrowseIllsCtrlr, NavMenuView, ContentCtrlr, ContentVw) {
  var controllerCtx,
