define(['js/core/core',
  ...
  function IllustrationBrowserView(viewModel) {
    ...
    //rather than checking remove the handlers if they exist!
    this.$next.off('click');
    this.$prev.off('click');
...
//      this.getNavView().reloadOnResize = false;
...
//      $('.illustrationBrowser .illustrations').css('left', xpos + 'px');
  ...
  ibvP.moveToItem = function(pos) {
    ...
    //console.log(this.getViewModel().getModelData().illustrations[pos].toFit);
